...
import { ContentNode } from "./steps/preview/lexical_preview_content";
import ClickAwayListener from "react-click-away-listener";
import { ElementAbsoluteCoordinate } from ".";
import { useLexicalComposerContext } from "@lexical/react/LexicalComposerContext";
import { $createNodeSelection, $getNodeByKey, $getSelection, $setSelection, BaseSelection, COMMAND_PRIORITY_EDITOR, SELECTION_CHANGE_COMMAND } from "lexical";
...
> = ({ isOpen, onClose, children, actions }) => {
  ...
  useEffect(() => {
    const listenToSelection = editor.registerCommand(SELECTION_CHANGE_COMMAND, () => {
  ...
  useEffect(() => {
    const calculateSelection = () => {
      ...
      editor.getEditorState().read(() => {
        ...
        const rangeSelection = lexSelection.isCollapsed() ? undefined : {
